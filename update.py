...
try:
    try:
        test_connect = str(requests.get("http://www.github.com/moayad-star/network_scanning"))
    ...
    system("apt upgrade -y ; cd .. ; rm -rif network_scanning ; git clone https://github.com/moayad-star/network_scanning.git")
